...
describe('`<ColumnSort />`', () => {
    ...
    it('renders `caret-down` icon without preset sorter', () => {
        ...
        expect(dispatch).toHaveBeenCalledWith(expect.objectContaining($do.bcAddSorter({
            bcName: 'bcExample',
    ...
    it('dispatches `bcFetchDataPages` action for infinite pagination', () => {
        ...
        dispatch.mock.calls[1] = expect.objectContaining($do.bcFetchDataPages({
            bcName: 'bcExample',
    ...
    it('dispatches `bcForceUpdate` action for regular pagination', () => {
        ...
        wrapper.find(Icon).simulate('click')
        expect(dispatch).toHaveBeenCalledTimes(2)
        dispatch.mock.calls[1] = expect.objectContaining($do.bcForceUpdate({
            bcName: 'bcExample',
            widgetName: 'widget-examle'
        }))
        mock.mockRestore()
